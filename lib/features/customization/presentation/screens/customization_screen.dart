        ...
        child: Column(children: [
          ...
          Padding(
            ...
            child: Column(children: [
              ...
              SliderSection(title: 'customization.sweetness'.tr(), steps: 5, labels: List.generate(5, (i) => 'customization.sweetness_labels.$i'.tr()), initial: 2),
              const SizedBox(height: 48),
              SliderSection(title: 'customization.espresso_intensity'.tr(), steps: 4, labels: List.generate(4, (i) => 'customization.intensity_labels.$i'.tr()), initial: 1),
              const SizedBox(height: 48),
              _buildAdditions(tt),
            ]),
          ),
