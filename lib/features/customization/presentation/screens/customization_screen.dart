                  ...
                  child: Column(
                    children: [
                      ...
                      const SliderSection(
                        title: 'Sweetness',
                        steps: 5,
                        labels: ['None', 'Light', 'Standard', 'Extra', 'Heavy'],
                        initial: 2,
                      ),
                      const SizedBox(height: 48),
                      const SliderSection(
                        title: 'Espresso Intensity',
                        steps: 4,
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'A meticulous blend of our house espresso, cut with chilled oat milk.',
                  style: tt.bodySmall,
                ),
              ],
            ),
