          ...
          child: Column(children: [
              ...
              child: Stack(children: [
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Iced Oat Cortado',
                          style: tt.headlineMedium?.copyWith(
                              fontSize: 36, color: cs.onSurface)),
                      const SizedBox(height: 8),
                      Text('A meticulous blend of our house espresso, cut with chilled oat milk.',
                          style: tt.bodySmall),
                    ],
                  ),
                ),
            ...
            Padding(
              ...
              child: Column(children: [
                ...
                const SliderSection(title: 'Sweetness', steps: 5, labels: ['None', 'Light', 'Standard', 'Extra', 'Heavy'], initial: 2),
                const SizedBox(height: 48),
                const SliderSection(title: 'Espresso Intensity', steps: 4, labels: ['Single', 'Double', 'Triple', 'Quad'], initial: 1),
                const SizedBox(height: 48),
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('Curated Additions', style: tt.headlineMedium?.copyWith(fontSize: 24)),
                      ],
                    ),
                  ),
