...
class AccountScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ProfileCubit, ProfileState>(
      builder: (context, state) {
        ...
        final loyaltyPoints = switch (state) {
          ProfileLoaded(:final loyaltyPoints) => loyaltyPoints,
          ProfileUpdating(:final loyaltyPoints) => loyaltyPoints,
          _ => null,
        };
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            children: [
              _buildProfileHeader(context, cs, tt, profile),
              const SizedBox(height: 40),
              LoyaltyCard(points: loyaltyPoints ?? 0),
              const SizedBox(height: 40),
  ...
  Widget _buildProfileHeader(
    ...
    return GestureDetector(
      onTap: () => context.read<ShellCubit>().pushSecondary(const EditProfileRoute()),
      child: Container(
        ...
        child: Row(children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: cs.primary.withAlpha(77), width: 2),
            ),
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('profile_screen.view_profile'.tr(), style: tt.bodySmall),
            ]),
          ),
