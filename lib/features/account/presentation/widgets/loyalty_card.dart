...
class LoyaltyCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      LoyaltyProgressBar(progress: tier.progress, selectedTierIndex: tier.index),
    ]);
  }

  Widget _buildPointsRow(BuildContext context, ColorScheme cs, TextTheme tt, String targetText) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      Row(children: [
        Text(points.toStringAsFixed(2), style: tt.headlineMedium?.copyWith(fontSize: 28, fontWeight: FontWeight.w900, color: cs.onSurface)),
      ...
      GestureDetector(
        onTap: () => context
            .read<ShellCubit>()
            .pushSecondary(const LoyaltyHistoryRoute()),
        child: Row(children: [
          Text(targetText,
